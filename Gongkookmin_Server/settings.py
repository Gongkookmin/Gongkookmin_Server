...
EMAIL_DOMAIN_RESTRICTION_LIST = ('kookmin.ac.kr',)

SITE_ID = 1
ACCOUNT_ADAPTER = 'api_server.adapter.OnlyForKookminAdapter'
...
REST_AUTH_SERIALIZERS = {
    'LOGIN_SERIALIZER': 'api_server.serializers.CustomLoginSerializer',
}